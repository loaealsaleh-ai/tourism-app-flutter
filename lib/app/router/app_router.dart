...
// تأكد من أن هذا المسار يطابق موقع الملف في مشروعك (انظر للصورة التي أرسلتها، المسار قد يكون مختلفاً قليلاً)
...
class AppRouter {
  ...
  late final GoRouter router = GoRouter(
    routes: <RouteBase>[
      ...
      GoRoute(path: routHotelsScreen, builder: (context, state) => const HotelsView()),
      GoRoute(path: routRoomDetails, builder: (context, state) => const RoomDetailsScreen()),
      GoRoute(path: routBookingScreen, builder: (context, state) => const BookingScreen()),
      GoRoute(path: routSuccessScreen, builder: (context, state) => const SuccessScreen()),
      GoRoute(path: routExploreScreen, builder: (context, state) => const ExploreScreen()),
      GoRoute(path: routPlaceDetailsScreen, builder: (context, state) => const PlaceDetailsScreen()),
      GoRoute(path: routCommentsScreen, builder: (context, state) => const CommentsScreen()),

      // تعريف مسارات المطاعم باستخدام الأسماء الصحيحة للكلاسات:
      GoRoute(
      ...
      GoRoute(
        ...
        builder: (context, state) => const RestaurantDetailsScreen(), // الاسم الصحيح للكلاس
      ),
      GoRoute(
